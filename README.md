...
* [bahanonu/calciumImagingAnalysis](https://github.com/bahanonu/calciumImagingAnalysis) - calciumImagingAnalysis (ciapkg) or CIAtah (pronounced cheetah): a software package for calcium imaging analysis of one- and two-photon imaging datasets. Documentation: https://git.io/ciapkg_docs.
...
* [rulixiang/ChangeDetectionPCAKmeans](https://github.com/rulixiang/ChangeDetectionPCAKmeans) - MATLAB re-implementation for Unsupervised Change Detection in Satellite Images Using Principal Component Analysis and k-Means Clustering.
...
* [GaoBoYu599/Optimization_Algorithm](https://github.com/GaoBoYu599/Optimization_Algorithm) - 梯度下降、牛顿法、共轭梯度法、蒙特卡洛、模拟退火、粒子群、蚁群、全局最优搭配局部最优算法的matlab和python程序
