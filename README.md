...
* [layumi/Image-Text-Embedding](https://github.com/layumi/Image-Text-Embedding) - TOMM2020 Dual-Path Convolutional Image-Text Embedding    https://arxiv.org/abs/1711.05535
...
* [hiroyuki-kasai/NMFLibrary](https://github.com/hiroyuki-kasai/NMFLibrary) - MATLAB library for non-negative matrix factorization (NMF): Version 1.8.1
...
* [precise-simulation/featool-multiphysics](https://github.com/precise-simulation/featool-multiphysics) - FEATool Multiphysics - "Physics Simulation Made Easy"   (Fully Integrated FEA, FEniCS, OpenFOAM, SU2 Solver GUI & Simulation Platform)
...
* [paulyang1990/QuadrupedSim](https://github.com/paulyang1990/QuadrupedSim) - A quadruped robot simulator in Matlab/Simulink
...
* [13952522076/CollaborativeFiltering](https://github.com/13952522076/CollaborativeFiltering) - matlab, collaborative filtering, MovieLens dataset，The movie recommendation system
...
* [MrGiovanni/Active-Learning](https://github.com/MrGiovanni/Active-Learning) - Official Matlab demo for AIFT - CVPR 2017 & Medical Image Analysis
...
* [mstorath/Pottslab](https://github.com/mstorath/Pottslab) - Multilabel image segmentation (color/gray/multichannel) based on the Potts  model (aka piecewise constant Mumford-Shah model)
...
* [iqiukp/Support-Vector-Data-Description-SVDD](https://github.com/iqiukp/Support-Vector-Data-Description-SVDD) - MATLAB Code for abnormal detection or fault detection using Support Vector Data Description (SVDD).
...
* [wknoben/MARRMoT](https://github.com/wknoben/MARRMoT) - Modular Assessment of Rainfall-Runoff Models Toolbox - Matlab code for 46 conceptual hydrologic models
...
* [personqianduixue/Math_Model](https://github.com/personqianduixue/Math_Model) - 美国大学生数学建模竞赛、全国大学生数学建模竞赛、华为杯研究生数学建模、数学建模美赛论文，数学建模国赛论文、LaTeX模板、国赛LaTeX模板、美赛LaTeX模板、mathorcup历年论文、研究生数学建模历年论文、电工杯、华中赛、APMCM亚太地区数学建模、深圳杯、中青杯、华东杯、数维杯、东三省数学建模、认证杯、数学建模书籍、数学建模算法、国赛评阅要点、数学建模word模板、软件模型算法汇总、MATLAB算法、常用Matlab代码、智能算法
...
* [chengji253/Multiple-fixed-wing-UAVs-flight-simulation-platform](https://github.com/chengji253/Multiple-fixed-wing-UAVs-flight-simulation-platform) - A multiple fixed-wing UAVs flight simulation platform built by matlab and simulink.  一个小型固定翼无人机集群仿真演示平台
...
* [EnthalpyBill/BP-Neural-Network-Matlab](https://github.com/EnthalpyBill/BP-Neural-Network-Matlab) - BP Neural Network in Matlab.
...
* [YonghaoXu/RPNet](https://github.com/YonghaoXu/RPNet) - Hyperspectral Image Classification via a Random Patches Network
...
* [mawady/bus-segmentation](https://github.com/mawady/bus-segmentation) - MATLAB implementation to segment breast lesions in ultrasound images (ICIAR 2016)
...
* [JonathanCamargo/MoCapTools](https://github.com/JonathanCamargo/MoCapTools) - Matlab tools for motion capture analysis, including programmatically running OpenSim, and automatical gap-filling of data.
...
* [wwzjer/RainRemoval_ICCV2017](https://github.com/wwzjer/RainRemoval_ICCV2017) - Should We Encode Rain as Deterministic or Stochastic? In ICCV 2017.
...
* [gzsiri/supermodeling](https://github.com/gzsiri/supermodeling) - 专注数学建模优质资料整合与培训咨询！
...
* [Pamphlett/CoBigICP](https://github.com/Pamphlett/CoBigICP) - [IROS2020] CoBigICP: COrrentropy based BIdirectional Generalized ICP
...
* [barnesgroupICL/Driftfusion](https://github.com/barnesgroupICL/Driftfusion) - An open source drift diffusion code based in MATLAB for simulating solar cells
...
* [KKimura360/MLC_toolbox](https://github.com/KKimura360/MLC_toolbox) - A MATLAB/OCTAVE library for Multi-Label Classification
...
* [rezaahmadzadeh/Expectation-Maximization](https://github.com/rezaahmadzadeh/Expectation-Maximization) - Expectation-Maximization (EM) algorithm in Matlab
...
* [davidnbresch/climada](https://github.com/davidnbresch/climada) - OLD MATLAB version of CLIMADA phased out --> PLEASE USE https://github.com/CLIMADA-project/climada_python
...
* [vinthony/Dual_TVL1_Optical_Flow](https://github.com/vinthony/Dual_TVL1_Optical_Flow) - dual tvl1 optical flow matlab version
...
* [matlab-deep-learning/COVID19-Face-Mask-Detection-using-deep-learning](https://github.com/matlab-deep-learning/COVID19-Face-Mask-Detection-using-deep-learning) - The entire workflow of developing deep learning model for detecting face mask.
...
* [juliamatlab/julia-matlab-shuttle](https://github.com/juliamatlab/julia-matlab-shuttle) - Matlab interface for calling Julia
* [fediskhakov/dcegm](https://github.com/fediskhakov/dcegm) - Matlab implementation of DC-EGM algorithm from Iskhakov, Jorgensen, Rust and Schjerning (QE, 2017)
...
* [FESTUNG/FESTUNG](https://github.com/FESTUNG/FESTUNG) - The main project for the MATLAB / GNU Octave code of FESTUNG
...
* [uzh-rpg/rpg_event_lifetime](https://github.com/uzh-rpg/rpg_event_lifetime) - MATLAB Implementation of Event Lifetime Estimation
* [scienstanford/iqmetrics](https://github.com/scienstanford/iqmetrics) - Image Quality Metrics in Matlab
* [quanmingyao/NGMeet](https://github.com/quanmingyao/NGMeet) - Matlab Code for: "Non-local Meets Global: An Integrated Paradigm for Hyperspectral Denoising. Arvix. Dec 2018"
* [otoolej/qEEG_feature_set](https://github.com/otoolej/qEEG_feature_set) - NEURAL: a neonatal EEG feature set in Matlab
* [onebula/ONquant](https://github.com/onebula/ONquant) - 基于Matlab的事件驱动量化回测框架
* [netZoo/netZooM](https://github.com/netZoo/netZooM) - netZooM is a network biology package implemented in MATLAB.
...
* [hiroyuki-kasai/OLSTEC](https://github.com/hiroyuki-kasai/OLSTEC) - OnLine Low-rank Subspace tracking by TEnsor CP Decomposition in Matlab: Version 1.0.1
...
* [gradywright/spherepts](https://github.com/gradywright/spherepts) - A collection of matlab functions for experimenting with different point sets on the sphere
...
* [apetros/TDNetGen](https://github.com/apetros/TDNetGen) - A MATLAB toolbox to generate large-scale combined Transmission and Distribution networks
* [andrewssobral/tensor_toolbox](https://github.com/andrewssobral/tensor_toolbox) - MATLAB Tensor Toolbox (by Tamara Kolda)
* [ZacharyTaylor/motion-based-calibration](https://github.com/ZacharyTaylor/motion-based-calibration) - Matlab methods utilizing structure from motion in combination with the Levinson method to calibrate a Velodyne-camera system
...
* [EnricSala/influxdb-matlab](https://github.com/EnricSala/influxdb-matlab) - MATLAB client for InfluxDB
* [Clark-Youngdong-Son/minSnapTrajec_matlab](https://github.com/Clark-Youngdong-Son/minSnapTrajec_matlab) - MATLAB simulation for the paper 'Minimum snap trajectory generation and control for quadrotors
* [BrainardLab/mQUESTPlus](https://github.com/BrainardLab/mQUESTPlus) - MATLAB implementation of Watson's Quest+
...
* [precise-simulation/cfdtool](https://github.com/precise-simulation/cfdtool) - CFDTool - An easy to use OpenFOAM / SU2 / CFD simulation toolbox for MATLAB
...
* [dengwirda/jigsaw-geo-matlab](https://github.com/dengwirda/jigsaw-geo-matlab) - MATLAB bindings for JIGSAW(GEO): an unstructured mesh generator for geoscientific modelling.
...
* [SukritGupta17/Chess-Board-Recognition](https://github.com/SukritGupta17/Chess-Board-Recognition) - A Chess Board configuration recognition Computer Vision Project
...
* [ICB-DCM/PESTO](https://github.com/ICB-DCM/PESTO) - PESTO: Parameter EStimation TOolbox, Bioinformatics, btx676, 2017.
* [GiovanniBordiga/TOP-OPT-Plates](https://github.com/GiovanniBordiga/TOP-OPT-Plates) - MATLAB Code for Topology Optimization of Plates
...
* [wspr/bvh-matlab](https://github.com/wspr/bvh-matlab) - Parse BVH files (Biovision) for Matlab
* [vinhphunguyen/migfem](https://github.com/vinhphunguyen/migfem) - Isogeometric finite elements in Matlab
* [steven2358/sklearn-matlab](https://github.com/steven2358/sklearn-matlab) - Machine learning in Matlab using scikit-learn syntax
...
* [shicai/matlab](https://github.com/shicai/matlab) - Matlab Toolbox for Pattern Analysis and Computer Vision
...
* [niclasborlin/dbat](https://github.com/niclasborlin/dbat) - DBAT - The Damped Bundle Adjustment toolbox for Matlab
...
* [jonzhaocn/Simple-GAN-Base-on-Matlab](https://github.com/jonzhaocn/Simple-GAN-Base-on-Matlab) - simple Generative Adversarial Networks base on matlab
* [javierbarbero/DEAMATLAB](https://github.com/javierbarbero/DEAMATLAB) - Data Envelopment Analysis Toolbox for MATLAB
...
* [iqiukp/Relevance-Vector-Machine-RVM](https://github.com/iqiukp/Relevance-Vector-Machine-RVM) - MATLAB code for Relevance Vector Machine using SB2_Release_200.
...
* [geez0x1/CompliantJointToolbox](https://github.com/geez0x1/CompliantJointToolbox) - Compliant Joint Toolbox (CJT) for MATLAB and Simulink
...
* [SIMOGroup/SIMO-Package](https://github.com/SIMOGroup/SIMO-Package) - This package implements NURBS-based IsoGeometric Analysis (IGA) and is released freely for education and research purposes. These codes are written in MATLAB. All your contributions are always welcomed.
...
* [Hua-Zhou/TensorReg](https://github.com/Hua-Zhou/TensorReg) - Matlab toolbox for tensor regressions
...
* [ArrowLuo/LLE_Algorithm](https://github.com/ArrowLuo/LLE_Algorithm) - locally linear embedding algorithm code write by matlab
...
* [wenbihan/salt_iccv2017](https://github.com/wenbihan/salt_iccv2017) - SALT (iccv2017) based Video Denoising Codes, Matlab implementation
...
* [wang-boyu/coursera-machine-learning](https://github.com/wang-boyu/coursera-machine-learning) - MATLAB assignments in Coursera's Machine Learning course
...
* [summitgao/SAR_Change_Detection_CWNN](https://github.com/summitgao/SAR_Change_Detection_CWNN) - Matlab code for the GRSL19 paper "Sea ice change detection in SAR images based on convolutional-wavelet neural networks"
* [srp98/Prediction-using-Bayesian-Neural-Network](https://github.com/srp98/Prediction-using-Bayesian-Neural-Network) - Prediction of continuous signals data and Web tracking data using dynamic Bayesian neural network. Compared with other network architectures aswell.
* [simoneparisotto/MATLAB-Python-inpainting-codes](https://github.com/simoneparisotto/MATLAB-Python-inpainting-codes) - This is the companion software for the book "Partial Differential Equation Methods for Image Inpainting" (C.-B. Schönlieb, Cambridge University Press, 2015)
...
* [nickabattista/Holy_Grail](https://github.com/nickabattista/Holy_Grail) - An array of fluid solver codes, including Projection, Pseudo-Spectral (FFT), Lattice Boltzmann, and the Panel Method with implementations in both MATLAB and Python3
* [mws262/MATLAB-Reinforcement-Learning-Pendulum](https://github.com/mws262/MATLAB-Reinforcement-Learning-Pendulum) - Q-Learning pendulum swing-up problem with animation as it's learning.
...
* [kunegis/konect-toolbox](https://github.com/kunegis/konect-toolbox) - Octave/Matlab toolbox for network analysis – part of the KONECT project by Jérôme Kunegis, University of Namur
...
* [jl626/ORB-MATLAB](https://github.com/jl626/ORB-MATLAB) - MATLAB implementation of ORB (oriented fast rotated brief) without opencv mex
* [janklab/matlab-bench](https://github.com/janklab/matlab-bench) - Some utilities for exploring Matlab's behavior
* [ina111/MatRockSim](https://github.com/ina111/MatRockSim) - Matlab Rocket Flight Simulator
* [hli1221/imagefusion_mdlatlrr](https://github.com/hli1221/imagefusion_mdlatlrr) - MDLatLRR (IEEE TIP 2020)
* [gujans/THERMAID](https://github.com/gujans/THERMAID) - Thermo-Hydraulic Energy Resource Modelling for Application and Development and is a MATLAB program solving flow and heat transport in fractured porous media using the embedded discrete fracture method
...
* [csd111/dereverberation](https://github.com/csd111/dereverberation) - Single-Channel Dereverberation in Matlab
...
* [Xiaoming-Yu/ShadowRemoval](https://github.com/Xiaoming-Yu/ShadowRemoval) - MATLAB implementation of the paper "A New Shadow Removal Method using Color-Lines", CAIP 2017
...
* [HolmesShuan/K-Nearest-Neighbors-Hashing](https://github.com/HolmesShuan/K-Nearest-Neighbors-Hashing) - Matlab implementation of "K-Nearest Neighbors Hashing" (CVPR2019)
...
* [Decri/Multi-Scale-and-Depth-CNN-for-Pan-sharpening](https://github.com/Decri/Multi-Scale-and-Depth-CNN-for-Pan-sharpening) - Matlab implementation of IEEE JSTARS article "A Multiscale and Multidepth Convolutional Neural Network for Remote Sensing Imagery Pan-Sharpening", along with the IEEE GRSL article DRPNN. MatConvNet and Caffe are required for full implementation.
* [kendrickkay/knkutils](https://github.com/kendrickkay/knkutils) - MATLAB utility functions written by Kendrick Kay
* [AomanHao/Matlab-Image-Dehazing-Enhazing](https://github.com/AomanHao/Matlab-Image-Dehazing-Enhazing) - 图像去雾、图像增强、灰度直方图均衡化等
...
* [jcbmarques/clusterdv](https://github.com/jcbmarques/clusterdv) - Density valley clustering (cluserdv). Matlab implementation.
...
* [WCHN/CTseg](https://github.com/WCHN/CTseg) - Brain CT image segmentation, normalisation, skull-stripping and total brain/intracranial volume computation. Implemented in MATLAB.
* [EmanuelFeru/MotionGenerator](https://github.com/EmanuelFeru/MotionGenerator) - Analytical trapezoidal motion generator in Arduino and Matlab
* [wenli-vision/svmplus_matlab](https://github.com/wenli-vision/svmplus_matlab) - An implementation of SVM+
* [osqp/osqp-matlab](https://github.com/osqp/osqp-matlab) - Matlab interface for OSQP
* [jonzhaocn/GAN-Base-on-Matlab](https://github.com/jonzhaocn/GAN-Base-on-Matlab) - A implementation of GAN in matlab
...
* [philthinker/ICECUBE-VREPToolbox](https://github.com/philthinker/ICECUBE-VREPToolbox) - A Toolbox designed for CoppeliaSim remote API (MATLAB)
...
* [haxxorsid/watermark-dwt-matlab](https://github.com/haxxorsid/watermark-dwt-matlab) - MATLAB program with GUI to watermark images
...
* [GentleDell/imu_preintegration_matlab](https://github.com/GentleDell/imu_preintegration_matlab) - matlab code for imu preintegration on manifold
* [Pjer-zhang/matlabPlotCheatsheet](https://github.com/Pjer-zhang/matlabPlotCheatsheet) - A cheatsheet for those who plot with MATLAB
...
* [tuan-cs/GM_PHD_Filter](https://github.com/tuan-cs/GM_PHD_Filter) - GM-PHD filter in target tracking
...
* [iqiukp/Relevance-Vector-Machine](https://github.com/iqiukp/Relevance-Vector-Machine) - Regression application based on Relevance Vector Machine (RVM) using SB2_Release_200.
...
* [3140102441/Video-key-frame-extraction](https://github.com/3140102441/Video-key-frame-extraction) - 视频关键帧提取  matlab
* [plotly/plotly-graphing-library-for-matlab](https://github.com/plotly/plotly-graphing-library-for-matlab) - Plotly Graphing Library for MATLAB®
* [alexlaurence/NIfTI-Image-Converter](https://github.com/alexlaurence/NIfTI-Image-Converter) - 🖼 A lightweight neuroimaging .nii to .png converter for Matlab and Python users
* [ansleliu/NNAEC-NeuralNetworkbasedAcousticEchoCancellation](https://github.com/ansleliu/NNAEC-NeuralNetworkbasedAcousticEchoCancellation) - NNAEC-Neural Network based Acoustic Echo Cancellation
* [GarrettJenkinson/informME](https://github.com/GarrettJenkinson/informME) - An information-theoretic pipeline for methylation analysis of WGBS data
* [higham/matlab-guide-3ed](https://github.com/higham/matlab-guide-3ed) - Program files from MATLAB Guide, Third Edition
...
* [thu-zhanghl/Matlab101](https://github.com/thu-zhanghl/Matlab101) - 📚 Matlab 学习指南、路线及笔记整理
* [kupiqu/fig2svg](https://github.com/kupiqu/fig2svg) - fig2svg: a Matlab/GNU Octave Toolbox to Export Matlab/GNU Octave Figures in Scalable Vector Graphics (SVG) Format
* [tminka/fastfit](https://github.com/tminka/fastfit) - Fastfit matlab toolbox
...
* [janinethoma/image_navigation_matlab](https://github.com/janinethoma/image_navigation_matlab) - Matlab demo for our CVPR'19 publication: Mapping, Localization and Path Planning for Image-based Navigation using Visual Features and Map
* [davidstutz/nyu-depth-v2-tools](https://github.com/davidstutz/nyu-depth-v2-tools) - Tools used in [2] to pre-process the ground truth segmentations to evaluate superpixel algorithms.
* [StackOverflowMATLABchat/mlapptools](https://github.com/StackOverflowMATLABchat/mlapptools) - MATLAB class containing methods for programmatic uifigure modification
* [Noiredd/PEGAS-MATLAB](https://github.com/Noiredd/PEGAS-MATLAB) - MATLAB prototype code for PEGAS
...
* [ArgoDMQC/matlab_owc](https://github.com/ArgoDMQC/matlab_owc) - The OWC Matlab toolbox
* [albertgranalcoz/Next-Generation-5G-OFDM-Based-Modulations](https://github.com/albertgranalcoz/Next-Generation-5G-OFDM-Based-Modulations) - Compilation of the different MATLAB codes that were used for the experimental part of the research work presented in the article "Next Generation 5G OFDM-Based Modulations for Intensity Modulation-Direct Detection (IM-DD) Optical Fronthauling".
* [orchidas/Pitch-Tracking](https://github.com/orchidas/Pitch-Tracking) - Pitch detection algorithms in Matlab
* [tobiasfshr/gmm-ubm-speaker-identification-verification](https://github.com/tobiasfshr/gmm-ubm-speaker-identification-verification) - Implementation of a speaker identification and a speaker verification system based on Gaussian Mixture Models (GMM) in combination with and Universal Background Model (UBM) on the YOHO dataset in MATLAB.
* [oxfordcontrol/osqp-matlab](https://github.com/oxfordcontrol/osqp-matlab) - Matlab interface for OSQP
...
* [andrewssobral/ostd](https://github.com/andrewssobral/ostd) - Online Stochastic Tensor Decomposition for Background Subtraction in Multispectral Video Sequences
* [OHBA-analysis/osl-core](https://github.com/OHBA-analysis/osl-core) - A set of Matlab tools and scripts for running M/EEG analyses on CTF and Elekta Neuromag data
* [MaaniGhaffari/sampling_based_planners](https://github.com/MaaniGhaffari/sampling_based_planners) - This is a library for some of sampling-based motion planning algorithms implemented in MATLAB.
* [LIU-Yinyi/QuadcopterAnalysis](https://github.com/LIU-Yinyi/QuadcopterAnalysis) - Universal physical Analysis for Quadcopter about Control Based on Matlab.
...
* [lacerbi/ibs](https://github.com/lacerbi/ibs) - Inverse binomial sampling for efficient log-likelihood estimation of simulator models
* [eruffaldi/ukfmanifold](https://github.com/eruffaldi/ukfmanifold) - UKF over generalized manifold in Matlab
...
* [space-physics/igrf](https://github.com/space-physics/igrf) - International Geomagnetic Reference Field IGRF13 in Python and Matlab
* [bahanonu/calciumImagingAnalysis](https://github.com/bahanonu/calciumImagingAnalysis) - CIAtah (pronounced cheetah) or calciumImagingAnalysis (ciapkg): a software package for calcium imaging analysis of one- and two-photon imaging datasets. Documentation: https://git.io/ciatah_docs.
...
* [pcirujeda/CovGT-3DRegistration-matlab](https://github.com/pcirujeda/CovGT-3DRegistration-matlab) - A 3D Scene Registration Method via Covariance Descriptors and an Evolutionary Stable Strategy Game Theory Solver
...
* [cmap/cmapM](https://github.com/cmap/cmapM) - Connectivity Map analysis in MATLAB
...
* [zafarrafii/Z](https://github.com/zafarrafii/Z) - This repository contains a Matlab class, a Python module, a Jupyter notebook, and a Julia module which implement/illustrate several methods/functions for audio signal processing.
* [zhufengGNSS/gpstools_0.6.4](https://github.com/zhufengGNSS/gpstools_0.6.4) -  GpsTools (GT)是一个基于MATLAB的GPS/GNSS数据分析软件，该软件提供的功能有基于静态PPP的接收机位置估计、动态PPP、精密卫星定轨、卫星钟差估计、基于动态PPP的低轨卫星定轨、对流层参数估计、接收机时间传递等。
* [GaoBoYu599/Fourier-Transform](https://github.com/GaoBoYu599/Fourier-Transform) - 离散傅里叶变换、卷积、离散小波变换、τp变换、希尔伯特变换、希尔伯特-黄变换相关Matlab程序
* [ClarkZinzow/Nonlinear-Optimization-Algorithms](https://github.com/ClarkZinzow/Nonlinear-Optimization-Algorithms) - MATLAB implementations of a variety of nonlinear programming algorithms.
...
* [frozenca/ML-Murphy](https://github.com/frozenca/ML-Murphy) - Solutions for exercises and MATLAB example codes for "Machine Learning: A Probabilistic Perspective" by K. Murphy
* [YashBansod/Robotics-Dynamics-and-Control](https://github.com/YashBansod/Robotics-Dynamics-and-Control) - This contains all the codes of the Robot Dynamics and Control Labs. The imlementations model various kinds of manipulators and mobile robots for position control, trajectory planning and path planning problems. The codes are written on MATLAB 2017a.
* [petercorke/spatial-math](https://github.com/petercorke/spatial-math) - Spatial math primitives for MATLAB
