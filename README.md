...
* [Julie-Fabre/bombcell](https://github.com/Julie-Fabre/bombcell) - Automated manual curation and cell classification of spike-sorted electrophysiology data in MATLAB. Fine-tuned for kilosorted Neuropixels data.
...
* [ai-winter/matlab_motion_planning](https://github.com/ai-winter/matlab_motion_planning) - Motion planning and Navigation of AGV/AMR：ROS planner plugin implementation of A*, Theta*, JPS, D*, LPA*, D* Lite, RRT, RRT*, RRT-Connect, Informed RRT*, ACO, Voronoi, PID, DWA etc.
