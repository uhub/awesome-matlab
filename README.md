...
* [MOBATSim/MOBATSim](https://github.com/MOBATSim/MOBATSim) - MOBATSim (Model-based Autonomous Traffic Simulation Framework)
...
* [IDonotK/routeInVanet](https://github.com/IDonotK/routeInVanet) - Matlab语言编写，实现3种车联网的路由算法:AODV GPSR LSPR
...
* [EarthAndSpaceResearch/TMD_Matlab_Toolbox_v2.5](https://github.com/EarthAndSpaceResearch/TMD_Matlab_Toolbox_v2.5) - ESR provides Matlab software, the Tide Model Driver (TMD) package, to access specific polar models, output harmonic constants, and to make tidal predictions. The TMD package consists of low-level scripts.
