...
* [redglassli/Formation_Consensus_basic](https://github.com/redglassli/Formation_Consensus_basic) - A basic version for robot formation consensus and obstacle avoidance by MATLAB
...
* [Sun-Yize/Photo-Cartoonization](https://github.com/Sun-Yize/Photo-Cartoonization) - Image signal processing by matlab, in order to cartoon stylize real photos
...
* [ma-mehralian/EKFPnP_matlab_toolbox](https://github.com/ma-mehralian/EKFPnP_matlab_toolbox) - EKFPnP: A new probabilistic approach based on Extended Kalman Filter for camera pose estimation in image sequences
* [kobybibas/semi_global_matching](https://github.com/kobybibas/semi_global_matching) - Compute disparity map from stereo image with semi global matching algorithm.
...
* [guoliu/optimizer](https://github.com/guoliu/optimizer) - MCMC, Differential Evolution Markov Chain, Ensemble Kalman filter, Approximate Bayesian Computing-Population Monte Carlo, and modeling averaging methods in Matlab.
...
* [chrischia06/AlgoTradingSimulatedPaths](https://github.com/chrischia06/AlgoTradingSimulatedPaths) - Mean-Variance Portfolio Optimisation and Algorithmic Trading Strategies in MATLAB
* [chawat/NOMASystem](https://github.com/chawat/NOMASystem) - A MATLAB implementation of an OFDM based Power Domain NOMA System
...
* [Sun-Yize-SDUWH/Photo-Cartoonization](https://github.com/Sun-Yize-SDUWH/Photo-Cartoonization) - 通过matlab进行图像信号处理，将真实照片进行漫画风格化
